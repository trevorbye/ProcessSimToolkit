...
arrival_time_randomizer = TimeRandomizer("normal", normal_mean=180, normal_stddev=30)
...
# build time randomizer
main_process_randomizer = TimeRandomizer("triangular", triangle_min=30, triangle_mode=50, triangle_max=70)

# build process server, assume there are two employees serving lemonade to customers
main_process_server = Server(1, main_process_randomizer, "Main process Server (serving Lemonade)")
...
end_time = datetime.datetime(year=2018, month=7, day=7, hour=12, minute=0, second=0)
